<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="View_Application.aspx.cs" Inherits="View_Application" %>
...
<asp:Content ID="body" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table width="80%">
        ...
        <tr><td colspan="2" align="center" class="td_head">
            <asp:Label ID="Label1" runat="server" CssClass="heading" Text="View And Declare Fake Applications"></asp:Label></td></tr>
        <tr><td colspan="2"><hr /><br /></td></tr>
        <tr><td class="td_lab"><asp:Label ID="Label2" runat="server" Text="Select Type " CssClass="lab_head"></asp:Label></td><td class="td_txt"><asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" CssClass="has-feedback" Height="30px" Width="40%">
            <asp:ListItem>--Select--</asp:ListItem>
            <asp:ListItem>All</asp:ListItem>
            <asp:ListItem>Suspect</asp:ListItem>
        ...
        <tr><td class="img_td">
            ...
            <tr><td class="img_td"><asp:Image ID="f7" runat="server"></asp:Image></td>
                ...
                <td colspan="1img_td"><asp:Image ID="f9" runat="server"></asp:Image></td>
        ...
        <tr><td class="img_td">
           ...
           <tr><td><asp:Image ID="f22" runat="server"></asp:Image></td>
